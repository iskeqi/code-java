...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统管理-字典表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_upload_file`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_upload_file
-- ----------------------------
INSERT INTO `sys_upload_file` VALUES (12, 'afb81e42-0de5-42a0-8f52-e17b6cb96bf2发的说法.pdf', '2020-12-04/application/pdf/', 'application/pdf', 56592, 0, '2020-12-04 12:14:03', '2020-12-04 12:14:03');
INSERT INTO `sys_upload_file` VALUES (13, 'b44f6f66-ab7a-4365-8e67-4e2f0f71cecb发的说法.pdf', '2020-12-04/application/pdf/', 'application/pdf', 56592, 0, '2020-12-04 13:31:49', '2020-12-04 13:31:49');
INSERT INTO `sys_upload_file` VALUES (14, 'e9e868ba-42d5-412e-825f-0baf3ec6dd44Java开发手册（嵩山版）.pdf', '2020-12-04/application/pdf/', 'application/pdf', 1580978, 0, '2020-12-04 14:03:43', '2020-12-04 14:03:43');
